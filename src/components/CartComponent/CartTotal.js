        ...
        <div className="col-12 col-md-5 ml-auto mt-4">
          ...
          <div className="p-4 bg bg-white bg_white_rounded text-right">
            <div className="d-flex justify-content-between py-3">
              <h6 className="font-main font-weight-bold">سعر الشراء</h6>
              <h6>${Total}</h6>
            </div>
            <div className="d-flex justify-content-between py-3">
              <h6 className="font-main font-weight-bold">التوصيل</h6>
              <h6>1.23$</h6>
            </div>
            <hr />
            <div className="py-0">
            ...
            <Link to="/Checkout">
              <button
                type="button"
                className="btn_Follow_chach text-center mx-auto my-3 font-main font-weight-bold"
              >
                متابعة الدفع
              </button>
            </Link>
