      ...
      <div className="row mx-0">
        ...
        <div className="col-12 col-md-6 align-self-center mx-0 single1">
          ...
          <div className="d-flex justify-content-start">
            <h6 className="mb-0 pb-0 align-self-center font-main font-weight-bold">الالون</h6>
            <button className="btnW">ابيض</button>
            <button className="btnB clc">اسود رمادي</button>
          </div>
          <div className="d-flex justify-content-start pt-2">
          <h6 className="mb-0 pb-0 align-self-center font-main font-weight-bold">المقاس</h6>
